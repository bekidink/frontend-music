    ...
    <div className="w-screen p-4 flex items-center justify-center flex-col">
      <div className="w-full flex my-3  gap-20">
        <NavLink
          ...
          className="flex items-center justify-between px-4 py-3 border rounded-md border-gray-300 hover:border-gray-500 hover:shadow-md cursor-pointer bg-blue-700"
        >
          <IoAdd />
          New Song
        </NavLink>
